  ...
  <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
      <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
        ...
        <div class="md:7/12 lg:w-6/12">
          ...
          <p class="mt-6 text-gray-600">Nuestro Equipo esta formado por Genios creativos, Desarrolladores, Ingenieros y Arquitectos de software, especializados en las ultimas tecnologías con la finalidad de  resolver las  necesidades mas complejas</p>
...
<div class="py-16 bg-white">  
  <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
      <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
        ...
        <div class="md:7/12 lg:w-6/12">
          <h2 class="text-2xl text-gray-900 font-bold md:text-4xl">Somos Expertos</h2>
  ...
  <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
      ...
      <div class="md:5/12 lg:w-5/12">
        ...
        <div class="md:7/12 lg:w-6/12">
          ...
          <p class="mt-6 text-gray-600"></p>
          <p class="mt-4 text-gray-600">Trabajamos siguiendo una filosofía Agil que nos permite reaccionar rapido a los cambios de nuestro entorno y poder brindar soluciones creativas y solidas</p>
        </div>
